...
#      |anjas@@@@.com|
#      |anjas@*bangun.com|
#      |anjasku    test@bangun.com|anjaskutest@bangun.com|
#
...
#    Then nilai value country saat ini adalah <country> dan tidak berubah sesuai pilihan awal
#    Examples:
#      |country|
#      |Singapore|
#
...
#  Scenario: 18 - Click Flip ID brand icon will redirected user to home page
#    #Given user berada di halaman 'Sign Up' Flip ID
#    When use mengklik icon brand Flip ID di pojok kiri atas halaman 'SignUp'
#    Then user akan diarahkan ke halaman utama Flip ID

  #Scenario Outline: 19 - hyperlink di footer singup page >> copas dari scenario signin aja